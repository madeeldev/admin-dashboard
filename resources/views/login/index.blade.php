            ...
            <div class="mt-10 sm:max-w-[480px] sm:w-full sm:ml-auto sm:mr-auto">
                <div class="bg-white sm:pl-12 sm:pr-12 sm:rounded-lg shadow-lg pt-16 pb-16">
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <input id="remember-me" name="remember-me" type="checkbox" class="w-4 h-4 rounded">
                                    <label for="remember-me" class="text-sm ml-3 leading-6">Remember me</label>
                                </div>
                    ...
                    <p class="mt-10 text-center text-sm text-gray-500">
                        Don't have an account? <a href="{{ route('register') }}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Register here</a>
                    </p>
                </div>
